...
// more info: https://dev.wix.com/docs/velo/apis/wix-ecom-backend/back-in-stock-notifications/create-back-in-stock-notification-request
// wrap this into a hook, cause we need to call this client