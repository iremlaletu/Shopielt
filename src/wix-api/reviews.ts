...
export async function createProductReview(wixClient: WixClient, { productId, title, body, rating, media}: CreateProductReviewValues) {
...
export async function getProductReviews(wixClient: WixClient, {
  productId, contactId, limit, cursor
